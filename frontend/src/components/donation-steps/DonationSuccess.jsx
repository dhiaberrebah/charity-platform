...
const DonationSuccess = ({ cause, formData, donationAmount, onClose }) => {
  ...
  return (
    <div className="text-center space-y-6 py-4">
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 max-w-md mx-auto">
        ...
        <p className="text-blue-900 font-bold text-xl">#{Math.random().toString(36).substring(2, 10).toUpperCase()}</p>
      </div>
